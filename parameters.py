...
def basic_training_parameters(parser):
    ...
    parser.add_argument('--evaluation_metrics', nargs='+', default=['e_recall@1', 'e_recall@2', 'e_recall@4', 'nmi', 'f1', 'mAP_1000', 'mAP_lim', 'mAP_c', \
                                                                    'dists@intra', 'dists@inter', 'dists@intra_over_inter', 'c_recall@1', 'c_recall@2', \
                                                                    'c_recall@4', 'c_nmi', 'c_f1', 'c_mAP_1000', 'c_mAP_lim', 'c_mAP_c'], type=str, help='Metrics to evaluate performance by.')
